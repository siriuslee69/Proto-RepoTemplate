...
- Provide publish-safe templates for `README.md`, `CONTRIBUTING.md`, and `valk/` repo metadata.
...
- `valk/`
  - tracked templates for conventions, progress logging, and Valkyrie config scaffolding.
